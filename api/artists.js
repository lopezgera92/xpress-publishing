...
// GET/PUT/DELETE route paths contain artistId param
...
// Retrieves all comic book artists that are currently employed
...
// Retrieves individual comic book artist specified by id
artistsRouter.get('/:artistId', (req, res, next) => {
  res.status(200).json({artist: req.artist});
});

// Creates new entry for comic book artist 
...
// Updates entry for specified comic book artist
...
// Deletes entry of specified comic book artist
